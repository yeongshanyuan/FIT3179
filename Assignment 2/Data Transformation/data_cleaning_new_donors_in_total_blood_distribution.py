...
def create_yearly_blood_donations_by_state():
    ...
    Filter dates to be in between 2010 and 2024.
    ...
    df = df[(df["blood_type"].str.lower() == "all") & (df["year"].between(2010, 2024))]
...
def merge_blood_donations_and_new_donors():
    ...
    df_merged.to_csv(
        "Cleaned Datasets/New Donors and Total Blood Donations.csv",
        index=False,
    )
    print(df_merged)
